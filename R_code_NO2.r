...
# 9. Compute a PC over the 13 images
...
# 10. Compute the local variability (local standard deviation) of the first PC (Calcolo della variabilità sulla prima componente)
#library(RStoolbox)
